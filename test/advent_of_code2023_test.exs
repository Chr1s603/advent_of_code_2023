defmodule AdventOfCode2023Test do
  ...
  # test "day_18" do
  #   assert AdventOfCode2023.Day18.task1() == 0
  #   assert AdventOfCode2023.Day18.task2() == 0
  # end

  test "day_19" do
    assert AdventOfCode2023.Day19.task1() == 348378
    assert AdventOfCode2023.Day19.task2() == 121158073425385
  end
end
